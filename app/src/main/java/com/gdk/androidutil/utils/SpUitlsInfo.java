...
/**
 * Created by ${郭登科} on 2017/10/13.
 * 关于存储的工具类
 */

public class SpUitlsInfo {
    private static SharedPreferences sp;

    private static SharedPreferences getSp(Context context) {
        if (sp == null) {
            sp = context.getSharedPreferences("when", Context.MODE_PRIVATE);
        }
        return sp;
    }
     ...
     *
     * */
    final public boolean removeData(Context context, String key) {
        SharedPreferences preferences = getSp(context);
